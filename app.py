...
def quiz(details):
    if request.method == 'POST':
        ...
        apply = Applicants(app_id = essentials[0], name = essentials[1], gender = essentials[2], dob = essentials[3], email = essentials[4], o = o1, n= n1, c= c1, a= a1, e = e1, Personality = p[0])
